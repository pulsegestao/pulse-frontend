...
const features = [
  {
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M5 8h14M5 8a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v2a2 2 0 01-2 2M5 8l2 13h10l2-13" stroke="#0F766E" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  ...
  {
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><rect x="2" y="4" width="20" height="16" rx="3" stroke="#0D9488" strokeWidth="1.8"/><path d="M8 4v16M2 9h6M2 15h6" stroke="#0D9488" strokeWidth="1.8" strokeLinecap="round"/></svg>,
    title: "PDV Integrado",
    desc: "Ponto de venda direto no sistema. Registre vendas com rapidez e o estoque atualiza sozinho.",
    color: C.blue, bg: C.bluePale,
  },
  {
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6 6 0 10-12 0v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" stroke="#0D9488" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  ...
  {
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" stroke="#0F766E" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/></svg>,
