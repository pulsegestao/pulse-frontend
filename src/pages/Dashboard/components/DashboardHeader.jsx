    ...
    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
      ...
      >
        ...
        <div style={{ textAlign: "left" }}>
          <p style={{ fontSize: 13, fontWeight: 700, color: C.graphite, margin: 0, lineHeight: 1.2 }}>João Ribeiro</p>
          <p style={{ fontSize: 11, color: C.mid, margin: 0, lineHeight: 1.2 }}>Administrador</p>
        </div>
